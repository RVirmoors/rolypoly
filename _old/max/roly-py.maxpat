...
,
					"patching_rect" : [ 239.0, 79.5, 58.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.0, 109.5, 78.0, 67.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 40.0, 91.0, 22.0 ],
					"text" : "setminmax -1 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 564.37371826171875, 293.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 846.0, 744.0, 98.0, 22.0 ],
					"text" : "zmap 0 500 0. 1."
				}
...
,
					"patching_rect" : [ 1049.0, 681.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 959.745604999999955, 643.0, 76.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1049.0, 705.0, 300.0, 100.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 343.0, 125.0, 300.0, 100.0 ],
					"setminmax" : [ 0.0, 500.0 ],
					"setstyle" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 959.745604999999955, 607.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 445.245605000000069, 79.5, 272.5, 22.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.245605000000069, 19.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 445.245605000000069, 51.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 392.245605000000069, 79.5, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 571.995605000000069, 19.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 342.995605000000069, 68.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1019.75, 59.0, 77.0, 22.0 ],
					"text" : "receive~ guit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.245605000000069, 109.5, 64.0, 22.0 ],
					"text" : "send~ guit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.745604999999955, 151.0, 45.0, 22.0 ],
					"text" : "readall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 974.745605000000069, 151.0, 46.0, 22.0 ],
					"text" : "writeall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 698.745605000000069, 9.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1019.75, 151.0, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 721.0, 237.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 933.745605000000069, 51.0, 59.0, 22.0 ],
					"text" : "record $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 801.745604999999955, 370.0, 326.0, 36.0 ],
					"text" : "mubu.track guitar 1 audio @predef yes @samplerate audio @maxsize 60s @info gui \"autobounds 1, opacity 0.5\""
				}

			}
, 			{
				"box" : 				{
					"color" : [ 0.827450980392157, 0.090196078431373, 0.090196078431373, 1.0 ],
					"id" : "obj-64",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 933.745605000000069, 9.0, 32.0, 22.0 ],
					"text" : "r rec"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 698.745605000000069, 51.0, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 974.745605000000069, 106.0, 159.0, 22.0 ],
					"text" : "mubu.record~ 1 guitar audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 801.745604999999955, 151.0, 47.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 722.0, 101.0, 47.0, 22.0 ],
					"text" : "clearall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 681.0, 32.0, 22.0 ],
					"text" : "r rec"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 734.0, 269.0, 35.0, 22.0 ],
					"text" : "s rec"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.0, 96.0, 59.0, 22.0 ],
									"text" : "record $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 136.0, 65.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.0, 27.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 141.0, 155.0, 22.0 ],
									"text" : "mubu.record guitar d_g_diff"
								}
...
,
					"patching_rect" : [ 337.0, 716.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 721.0, 151.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.2, 0.007843137254902, 0.007843137254902, 1.0 ],
					"checkedcolor" : [ 0.901960784313726, 0.317647058823529, 0.03921568627451, 1.0 ],
					"id" : "obj-48",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 721.0, 175.0, 50.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 722.0, 46.0, 50.0, 50.0 ],
					"thickness" : 100.0
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 141.0, 142.0, 22.0 ],
									"text" : "mubu.record guitar descr"
								}
...
,
					"patching_rect" : [ 705.0, 293.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 801.745604999999955, 456.0, 352.0, 36.0 ],
					"text" : "mubu.track guitar 3 d_g_diff @predef yes @timetagged 1 @info gui \"shape steps, fgcolor red, autobounds 1\" @maxsize 60s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 801.745604999999955, 411.0, 358.0, 36.0 ],
					"text" : "mubu.track guitar 2 descr @predef yes @timetagged 1 @info gui \"fgcolor blue, autobounds 1\" @maxsize 60s"
				}
...
, 			{
				"box" : 				{
					...
					"outputviewname" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 801.745604999999955, 181.0, 291.0, 179.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 783.745604999999955, 46.0, 291.0, 179.0 ],
					"rangeruler_grid" : 0,
					"rangeruler_size" : 30,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.745604999999955, 242.0, 48.0, 22.0 ],
					"text" : "pipe 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.745604999999955, 203.0, 47.0, 22.0 ],
					"text" : "v descr"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 628.745604999999955, 160.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 846.0, 778.0, 47.0, 22.0 ],
					"text" : "v descr"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 337.0, 485.0, 51.0, 22.0 ],
									"text" : "s gbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 337.0, 454.0, 24.0, 24.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"text" : "1. 0. 0. 0. 0. 0. 0. 0. 0. 300. 150. 1. 0.875 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 93.0, 115.0, 124.0, 22.0 ],
					"text" : "OSC-route /play /next"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 416.5, 710.0, 363.0, 710.0, 363.0, 711.0, 346.5, 711.0 ],
					"order" : 1,
					"source" : [ "obj-114", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"midpoints" : [ 1058.5, 713.5, 1058.5, 713.5 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 1029.25, 174.0, 811.245604999999955, 174.0 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 984.245605000000069, 174.0, 811.245604999999955, 174.0 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 934.245604999999955, 174.0, 811.245604999999955, 174.0 ],
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-63", 0 ],
					"midpoints" : [ 943.245605000000069, 37.0, 711.0, 37.0, 711.0, 45.0, 708.245605000000069, 45.0 ],
					"order" : 1,
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 102.5, 146.0, 638.245604999999955, 146.0 ],
					"order" : 1,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 102.5, 146.0, 730.5, 146.0 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
