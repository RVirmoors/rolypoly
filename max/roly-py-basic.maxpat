...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 784.745605000000069, 20.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 758.745605000000069, 20.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1378.75, 217.0, 39.0, 22.0 ],
					"text" : "r save"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1310.75, 294.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1335.75, 259.0, 82.0, 22.0 ],
					"text" : "write $1, clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1224.0, 250.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1224.0, 294.0, 71.0, 22.0 ],
					"text" : "record~ guit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1272.686859130859375, 217.0, 77.0, 22.0 ],
					"text" : "receive~ guit"
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 9388.75646258503366, "ticks" ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 889.0, 325.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 924.0, 199.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 884.0, 199.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 292.0, 591.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 154.37371826171875, 752.0, 41.0, 20.0 ],
									"text" : "+ / -"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 75.37371826171875, 752.0, 41.0, 20.0 ],
									"text" : "value"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 13.0, 156.0, 50.0, 22.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 143.0, 127.0, 72.0, 22.0 ],
													"text" : "v note_after"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 170.62628173828125, 157.0, 150.0, 34.0 ],
													"text" : "only lets past first note after the drumhit"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 153.0, 112.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 49.999999738281247, 40.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 142.999999738281247, 40.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 49.999999738281247, 274.5, 30.0, 30.0 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-16", 0 ],
													"midpoints" : [ 70.0, 212.0, 333.62628173828125, 212.0, 333.62628173828125, 108.0, 151.62628173828125, 108.0, 151.62628173828125, 122.0, 152.5, 122.0 ],
													"source" : [ "obj-17", 1 ]
												}
...
,
									"patching_rect" : [ 263.373717999999997, 548.0, 95.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 339.373717999999997, 470.0, 45.000000261718753, 22.0 ],
									"text" : "107."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 194.000000261718696, 656.0, 123.0, 48.0 ],
									"text" : "gets shortest interval (before or after the drumhit)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 611.0, 349.0, 53.0, 34.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 154.37371826171875, 682.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 154.37371826171875, 722.0, 62.0, 22.0 ],
									"text" : "v delaysig"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.37371826171875, 722.0, 63.0, 22.0 ],
									"text" : "v delayms"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 75.37371826171875, 649.0, 41.0, 22.0 ],
									"text" : "zl sort"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.37371826171875, 613.0, 55.0, 22.0 ],
									"text" : "pak 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 75.37371826171875, 682.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 672.0, 470.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 39.5, 97.0, 22.0 ],
